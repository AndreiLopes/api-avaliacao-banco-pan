...
import br.com.bancoPan.repository.PessoaRepository;

/**
 * Classe Service de Pessoa
 * 
 * @author andrei
 *
 */
...
public class PessoaServiceImpl implements PessoaService {
	...
	public List<Endereco> consultarEnderecoPessoa(String cpf, String cep) {
		PessoaEntity pessoaEndereco = repository.findByCpfPessoaAndEnderecosCep(cpf.replace(".", "").replace("-", ""),
				cep.replace("-", ""));
		if (pessoaEndereco == null || pessoaEndereco.getEnderecos().isEmpty()) {
			return null;
		} else {
	...
	public Endereco alterarEnderecoPessoa(String cpf, Long enderecoId, Endereco enderecoAlterado) {
		...
		PessoaEntity pessoaEndereco = repository
				.findByCpfPessoaAndEnderecosIdEndereco(cpf.replace(".", "").replace("-", ""), enderecoId);
		if (pessoaEndereco == null || pessoaEndereco.getEnderecos().isEmpty()) {
			return null;
		} else {
