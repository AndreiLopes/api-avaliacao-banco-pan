...
import br.com.bancoPan.integration.IbgeHttpIntegration;
import br.com.bancoPan.integration.ViaCepHttpIntegration;
...
public class EnderecoServiceImpl implements EnderecoService {
	...
	public List<Estado> obterListaEstados() {
		...
		List<Localidade> localidades = ibgeService.obtemListaDeLocalidades();
	...
	public List<Municipio> obterListaMunicipios(Integer localidadeId) {
		...
		LOGGER.info("Obtendo lista de municipios com o parâmetro localidadeId: {localidadeId}, em IbgeService.",
				localidadeId);
		List<Localidade> localidades = ibgeService.obtemListaDeMunicipiosLocalidades(localidadeId);

		if (localidades.isEmpty()) {

			LOGGER.error("Nenhum municipio encontrado com o parâmetro localidadeId: {localidadeId}, em IbgeService.",
					localidadeId);
			return null;
		}

		LOGGER.error("Encontrados {} municipios com o parâmetro localidadeId: {localidadeId}, em IbgeService.",
				localidades.size());
